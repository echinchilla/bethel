...
<nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/">
                        <!-- Logo icon -->
                        <b><img src="<c:url value='/resources/images/logo.png'/>" alt="homepage" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text --> 
                        <span><img src="<c:url value='/resources/images/logo-text.png'/>" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
